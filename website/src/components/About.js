            ...
            <div className='max-w-[1340px] mx-auto px-4 py-2 '>
                <div>
                    ...
                    <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-4'>
                        ...
                        <AboutCard icon={<img src={earthIcon} alt="earth Icon" />} heading={<span className="text-green-500">Eathbending</span>} text='Earthbending, is the geokinetic ability to manipulate earth and rock in all their various forms, prevalent in the Earth Kingdom and the United Republic.
