...
const WinRatio = () => {
    ...
    return (
        <div className='max-w-[1240px] mx-auto py-12 mt-10 px-4 w-full h-screen flex flex-col justify-center'>
            <div id="BOX" className="mockup-window border bg-neutral-800 dark:bg-base-100 p-8 mt-10">
                <div className='space-x-8'>
                    ...
                    <div className='flex top-14 absolute right-16 px-4 float-right mx-12'>
                    ...
                    <div className='flex float-right absolute right-20'>
                        <div className="absolute flex mt-40 md:py-5">
                            Total numbers of wins/losses
                        </div>
