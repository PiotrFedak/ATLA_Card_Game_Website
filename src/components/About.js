            ...
            <div className='max-w-[1340px] mx-auto px-4 py-2 '>
                <div>
                    ...
                    <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-4'>
                        <AboutCard icon={<img src={windIcon} alt="wind Icon" />} heading={<span className="text-cyan-600">Airbending</span>} text=' is the aerokinetic ability to control and manipulate air.
